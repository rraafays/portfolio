...
const Page = () => {
    return (
        <Layout>
            <Container>
                <Banner
                    src={"/images/recipes/korean-fried-chicken.jpeg"}
                ></Banner>
                <Title>
                ...
                <Section delay={0.1}>
                    <Step stepN={1}>
                        prepare the chicken. add soy, water, sugar, salt, and
                        black pepper. let the mixture marinate for at least 30
                        minutes
                    </Step>
                    <Step stepN={2}>
                        add potato starch, flour, rice flour, chilli powder to
                        the chicken and mix it up
                    </Step>
                    <Step stepN={3}>
                        using a thick pot pour oil until half way heat until oil
                        reaches 170c (frying twice, once at a lower temperature
                        around 160c and again at 180c. you want the oil to be
                        higher because the temperature will drop once we put the
                        chicken in)
                    </Step>
                    <Step stepN={4}>
                        gently drop the battered chicken into the oil. agitate
                        the chicken to make sure it fries evenly. fry until pale
                        golden brown
                    </Step>
                    <Step stepN={5}>
                        sieve the chicken pieces out and place on wire shake
                        excess oil off. refry the chicken at 180c for a few
                        minutes until golden brown
                    </Step>
                    <Step stepN={6}>
                        combine gochujang, soy sauce, water, ketchup, honey,
                        sugar and chilli oil to make the sauce. pour it over the
                        chicken then toss it
                    </Step>
                    <Step stepN={7}>
                        finally garnish with crushed peanuts, sesame seeds,
                        spring onions
                    </Step>
                    <Step stepN={8}>enjoy with a can of coke</Step>
                </Section>
            </Container>
        </Layout>
    );
